...
namespace EPAM.Tests.task04_find_min_max
{
    public class Program
    {
        public static bool FindMinMax(int[][] array, out int min, out int max)
        {
            ...
            foreach (var arr in array)
            {
                ...
                var currentMax = MaxValue(arr);
                var currentMin = MinValue(arr);
        ...
        public static int MinValue(IEnumerable<int> arr)
        {
        ...
        public static int MaxValue(IEnumerable<int> arr)
        {
        ...
        private static void TestReturnedValues(int testCaseNumber, int[][] array, bool expectedResult, int expectedMin,
            int expectedMax)
        {
            try
            {
